        ...
        <form className="space-y-6">
          <div>
            ...
            <input
              type="email"
              id="email"
              className="mt-1 block w-full p-3 border border-gray-600 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm bg-gray-700 text-white"
              required
            />
          </div>
          <div>
